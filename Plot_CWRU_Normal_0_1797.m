...
Fr = 1797/60;
F_rolling = Fr*4.7135;
Sig_N = X097_DE_time(12000:12000*2, 1);
N = length(Sig_N);
t = (0 : N-1)/Fs;
Sig_Combine = Sig_N;
...
% save figure
SaveFigureLinchao('19a_CWRU_Experiment_T',FlagFigureAutoSave,currentFolder)
...
% save figure
SaveFigureLinchao('19b_CWRU_Experiment_Enlargement',FlagFigureAutoSave,currentFolder)
