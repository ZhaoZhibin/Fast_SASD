function [WindowPosition11,h11,h21] = Subfigure21_cm(wb,hb,margin_left,margin_right,margin_top,margin_bottom)
...
HF = 2*(hb+margin_top+margin_bottom);   % HF: the Height of the Figure    
...
h21 = [ml_delta,                1-mt_delta-hb_unit-hbox_unit,	wb_unit,	hb_unit];    
